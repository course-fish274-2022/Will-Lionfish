...
habitat_names <- c("Mixed", "High-Profile Reef", "Low-Profile Reef", "Sloping Dropoff", "Wall", "Ledge", "Grass", "Sand", "Rubble", "Artificial", "Open Water")
surveys %>% 
  filter(habitat == 1:11) %>% 
  group_by(year) %>%
  ...
  facet_grid(labeller = habitat_names)
```