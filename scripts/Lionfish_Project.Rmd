...
habitat_names <- c('1' = "Mixed", '2' = "High-Profile Reef", '3' = "Low-Profile Reef",
                   '4' ="Sloping Dropoff", '5' ="Wall", '6' ="Ledge", '7' ="Grass", 
                   '8' ="Sand", '9' = "Rubble", '10' = "Artificial", '11'= "Open Water")
surveys %>% 
  group_by(year) %>%
  filter(habitat %in% 1:11) %>% 
  mutate(habitat_type = habitat_names) %>% 
